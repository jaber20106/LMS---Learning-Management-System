...
export default function InstructorDashboard() {
  ...
  async function loadDashboard() {
    ...
    try {
      const userResponse =
        await fetch(
          "https://lms-learning-management-system-syom.onrender.com/api/users/me?populate=*",
          {
            method: "GET",
            headers: {
      ...
      const courseResponse =
        await fetch(
          "https://lms-learning-management-system-syom.onrender.com/api/courses?populate=lessons",
          {
            method: "GET",
            headers: {
              Authorization: `Bearer ${token}`,
  ...
  async function handleDeleteCourse(
    ...
    try {
      const response =
        await fetch(
          `https://lms-learning-management-system-syom.onrender.com/api/courses/${documentId}`,
          {
            method: "DELETE",
            headers: {
              Authorization:
