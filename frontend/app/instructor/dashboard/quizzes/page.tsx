  ...
  return;
    ...
    try {
      const response = await fetch(
        "https://lms-learning-management-system-syom.onrender.com/api/courses?status=draft&populate=lessons",
        {
          method: "GET",
          headers: {
  ...
  async function handleCreateQuiz(
    ...
    try {
      ...
      const quizResponse = await fetch(
        "https://lms-learning-management-system-syom.onrender.com/api/quizzes",
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${token}`,
